...
a = 0.343;//константа, характеризующая степень влияния различных факторов на потери армии х
b = 0.895;//эффективность боевых действий армии у
c = 0.699;//эффективность боевых действий армии х
h = 0.433;//константа, характеризующая степень влияния различных факторов на потери армии у
