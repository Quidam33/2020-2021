...
a = 0.401;//константа, характеризующая степень влияния различных факторов на потери армии х
b = 0.707;//эффективность боевых действий армии у
c = 0.606;//эффективность боевых действий армии х
h = 0.502;//константа, характеризующая степень влияния различных факторов на потери армии у
