...
subtitle: "Модель распространения рекламы - вариант 36"
...
3.	$\frac{dn}{dt} = (0.94\sin (t) + 0.94\cos (t)n(t))(N-n(t))$

При этом объем аудитории $N = 1040$, в начальный момент о товаре знает 9 человек.
